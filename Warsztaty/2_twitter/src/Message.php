<?php
    ...
    class Message {
        ...
        public static function loadMessages($conn, $id, $type) {
        ...
        public function saveMessagetoDB($conn) {
            ...
            if ($result) {
                ...
                if ($conn->errno == 1452) {
                    "konto użytkownika zostało usinięte nie możesz mu wysłać wiadomości";
                } else {
        ...
        public static function displayMessages($messages, $conn) {
                    ...
                    if ($result != FALSE && $result->num_rows == 1) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            Print' <form method="POST">'
                                . '<input type="hidden" name="displayessage" value="' . $message->getId() .
                                '"><input type="hidden" name="showMessages" value="id">
                                <button type="submit" action="#">zobacz całą wiadomość </button></form>';
                        }
                    }
                    if ($message->isReaded == 0) {
                        print "</strong>";
        ...
        public static function displayDetailsMessagesOnPage($message, $conn) {
